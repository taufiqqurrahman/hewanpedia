...
import simple.example.hewanpedia.model.Lalat;

public class DataProvider {
    private static List<Hewan> hewans = new ArrayList<>();

    private static List<Lalat> intDataLalat(Context ctx) {
        List<Lalat> lalats = new  ArrayList<>();
        lalats.add(new Lalat("Lalat Botfly", "austria",
                "Telur-telur botfly tersebut akan menetas dan berubah menjadi larva dalam kurun waktu 6 minggu. Nah, di sinilah letak mengerikannya. Selama telur tersebut masih melekat dan belum menetas di dalam tubuh nyamuk, lalu nyamuk tersebut menempel pada makhluk hidup lain untuk menghisap darahnya.",
                R.drawable.lalat_botfly));
        lalats.add(new Lalat("Calliphora vomitoria","amerika selatan",
                "ni merupakan jenis hewan yang berbahaya karena bisa menularkan bakteri salmonella. Mereka juga bisa menyebabkan penyakit disentri. Kebiasaannya adalah hinggap di bangkai hewan, tempat sampah, dan area-area yang memiliki bau busuk lainnya.",
                R.drawable.lalat_hijau));
    ...
    private static void initAllHewans(Context ctx) {
        ...
        hewans.addAll(intDataLalat(ctx));
    }
